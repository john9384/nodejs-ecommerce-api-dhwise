...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Marie.Howell',
      password: 'vUSga7ow_NhR39o',
      email: 'Casandra.Renner41@hotmail.com',
      name: 'Erma Senger',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 373,
      mobileNo: '(606) 030-8399',
      resetPasswordLink: {},
      loginRetryLimit: 895,
      loginReactiveTime: '2024-04-26T00:49:07.284Z',
      id: '657e0666d2f4e21cc6d52ae9'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Lulu9',
        'password':'NsGbCCAkQ4R3iC6',
        'email':'Ludie74@hotmail.com',
        'name':'Casey Kihn',
        'shippingAddress':[{
          '_id':false,
          'pincode':'orchid',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Ludie74@hotmail.com', });
