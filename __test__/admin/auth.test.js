...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Ted.Keeling88',
      password: 'uLkgnAdY_XH1CIB',
      email: 'Bernard81@hotmail.com',
      ...
      userType: 523,
      mobileNo: '(009) 137-1007',
      resetPasswordLink: {},
      loginRetryLimit: 825,
      loginReactiveTime: '2024-05-31T12:49:27.606Z',
      id: '657e0666d2f4e21cc6d52a7d'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Keeley31',
        'password':'iYuR1rO3ox_d0mx',
        'email':'Amparo.Koelpin80@hotmail.com',
        'name':'Kerry Gerlach',
        'shippingAddress':[{
          '_id':false,
          'pincode':'panel',
          'address1':'methodologies',
          'address2':'Functionality',
          'landmark':'solid',
          'city':'Philippines',
          'isDefault':false,
          'state':'red',
          'addressType':'Profit-focused',
          'fullName':'Loop',
          'mobile':334,
          'addressNo':538
        }],
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Amparo.Koelpin80@hotmail.com', });
